...
"x86_64-linux-thread-multi-4.0.4-2-arch" or
	die "Errno architecture (x86_64-linux-thread-multi-4.0.4-2-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
